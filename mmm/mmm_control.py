        ...
        **kwargs : dict
        ...
        with pm.Model(
            ...
            if (
                ...
                # Case 1: 개별 control 별 Prior (dict 형태)
...
class MMM(
    ...
    3. This class also allow us to calibrate the model using:
        ...
        * Adding lift tests to the likelihood function via the :meth:`add_lift_test_measurements <madmatics.mmm.mmm.MMM.add_lift_test_measurements>` method.
