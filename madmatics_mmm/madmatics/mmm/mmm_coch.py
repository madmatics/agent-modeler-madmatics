        ...
        **kwargs : dict
        ...
        with pm.Model(coords=self.model_coords) as self.model:
            ...
            if (
                ...
                chco_contributions = pm.Deterministic(
                    name="chco_contributions",
                    var=control_contributions_sum + channel_contributions.sum(axis=-1),
                    dims=("date",)
                )
                mu_var = intercept + chco_contributions
            else:
